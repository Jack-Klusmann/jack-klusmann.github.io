...
Despite the complexity of the underlying stack, interaction follows a **simple and intuitive flow**.

#### 1. Registration and Alignment

The user scans a QR marker attached to the robot base. The system registers the simulated model to the physical robot and overlays it in place. Once aligned, the **digital twin remains spatially anchored**, enabling interaction with a unified hybrid embodiment.
